...
import pkt_xmt_epy_module_0 as epy_module_0  # embedded python module
...
class pkt_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.file_name = file_name = '/home/kumuthu/Documents/Com Design Project/Text1'
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, 768e3,True)
